...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      ...
      <sch:assert test="count(f:extension[@url = 'sequencerId']) &lt;= 1">extension with URL = 'sequencerId': maximum cardinality of 'extension' is 1</sch:assert>
      ...
      <sch:assert test="count(f:extension[@url = 'runAlias']) &lt;= 1">extension with URL = 'runAlias': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'flowCellId']) &lt;= 1">extension with URL = 'flowCellId': maximum cardinality of 'extension' is 1</sch:assert>
      ...
      <sch:assert test="count(f:extension[@url = 'fragmentSize']) &lt;= 1">extension with URL = 'fragmentSize': maximum cardinality of 'extension' is 1</sch:assert>
      ...
      <sch:assert test="count(f:extension[@url = 'captureKit']) &lt;= 1">extension with URL = 'captureKit': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'baitDefinition']) &lt;= 1">extension with URL = 'baitDefinition': maximum cardinality of 'extension' is 1</sch:assert>
